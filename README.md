...
![JObfuscator Java Obfuscator Windows Client](https://raw.githubusercontent.com/PELock/JObfuscator-CSharp/main/img/jobfuscator-java-obfuscator-obfuscation-1-0-main.png)
...
![Java JAD Decompiler](https://raw.githubusercontent.com/PELock/JObfuscator-CSharp/main/img/java-jad-decompiler-decompilation.png)
...
////////////////////////////////////////////////////////////////////////////////
//
// An output from JObfuscator v1.0.0 - Bartosz Wójcik
//
...
The preferred way of WebApi interface installation is via [NuGet](https://www.nuget.org/) (targets **.NET 8**):

Run:

```bash
dotnet add package JObfuscator
```

From Visual Studio NuGet Package Manager Console:

```powershell
Install-Package JObfuscator
```
...
```xml
<ItemGroup>
  <PackageReference Include="JObfuscator" Version="1.0.0" />
</ItemGroup>
```

The package listing on NuGet will be at https://www.nuget.org/packages/JObfuscator/ after publishing. To run the included samples from this repository, use each example project alongside `jobfuscator-example*.cs`:

```bash
dotnet run --project examples/jobfuscator-example-simple.csproj
```
...
![JObfuscator Java Obfuscator Obfuscation Options](https://raw.githubusercontent.com/PELock/JObfuscator-CSharp/main/img/jobfuscator-java-obfuscator-obfuscation-1-0-options.png)

### Obfuscated Java code

![JObfuscator Obfuscated Java Code](https://raw.githubusercontent.com/PELock/JObfuscator-CSharp/main/img/jobfuscator-java-obfuscator-obfuscation-1-0-obfuscated.png)

### JObfuscator command line version

![JObfuscator Command Line Version](https://raw.githubusercontent.com/PELock/JObfuscator-CSharp/main/img/jobfuscator-java-obfuscator-obfuscation-1-0-console-comand-line.png)
